fileName = input("Please give me the name of the file containing the matrix! ", "s");
numofIterations = input("Give me the number of iterations. Write 'inf' if you want to optimize endlessly! ", "s");
numofCores = input("Give me the number of cores as the power of 2! If you want to use 2^n cores then write n! ");
x = 0;
counter_max =0;
if(strcmp(tolower(numofIterations), 'inf'))
	x = 1;
	counter_max = 1;
else
